...
* Objective
  - To view and take the self evaluation and cancel the self evaluation and then submit the self evaluation of “Registers” experiment
...
* Post conditions
   - Nil
* Test Steps
  1. Refer to Registers_04_selfevaluation_p1.org
